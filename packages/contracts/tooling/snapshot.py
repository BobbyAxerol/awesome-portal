...
TRACKED = (
    ...
    "schemas/execution-profile-realtime.v1.schema.json",
    ...
    "fixtures/execution-profile-realtime.snapshot.valid.json",
    "fixtures/execution-profile-realtime.delta.valid.json",
    "fixtures/execution-profile-realtime.heartbeat.valid.json",
    "fixtures/execution-profile-realtime.auth-expired.valid.json",
    "fixtures/execution-profile-realtime.projection-gap.valid.json",
    ...
    "generated/execution-profile-realtime.d.ts",
    ...
    "openapi/execution-profile-realtime.openapi.json",
