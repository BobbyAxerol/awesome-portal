...
ENV PYTHONDONTWRITEBYTECODE=1 \
    PYTHONUNBUFFERED=1 \
    PYTHONPATH=/opt/quantbt-portal/src:/opt/quantbt-portal \
    NUMBA_CACHE_DIR=/var/cache/numba

WORKDIR /opt/quantbt-portal
...
COPY apps/quantbt-portal/backend/pyproject.toml apps/quantbt-portal/backend/README.md ./
COPY apps/quantbt-portal/backend/src ./src
...
COPY apps/quantbt-portal/strategy ./strategy
