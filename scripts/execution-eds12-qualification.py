...
INPUTS = (
    ...
    ("manager_v2_contract_decoder", "services/portal-execution-edge-rs/crates/manager-v2-contract/src/lib.rs"),
    ...
    ("projection_worker", "apps/control-api/src/execution/profile-projection.worker.ts"),
