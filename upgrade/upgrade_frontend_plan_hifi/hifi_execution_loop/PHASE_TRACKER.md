...
| — | Codex N02 incremental source contract | `PORTAL_REQUEST_VERIFIER_COMPLETE / OWNER_REQUEST_DISPATCHED / OWNER_PACK_PENDING / RUNTIME_V1_LOCKED` — request-only v2 schema + exact four-file digest envelope + 15-case fail-closed verifier; consolidated N02+N03 owner request sent to AWS-HK handoff path | Claude dùng typed gap/resync/retention/completeness fixtures, giữ Lane B fixture/unavailable; không chọn live reader trước owner acceptance + N03/N04 | `EX_BE_02_N02_INCREMENTAL_SOURCE_CONTRACT_REVISION.md`, `TRADING_SYSTEM_D4_PAPER_READ_V2_IMPLEMENTATION_REQUEST.md`, `CODEX_TO_CLAUDE_N02_INCREMENTAL_SOURCE_CONTRACT_HANDOFF.md` |
| — | Codex N03 owner implementation gate | `PORTAL_ACCEPTANCE_HARNESS_COMPLETE / OWNER_REQUEST_DISPATCHED / N02_OWNER_PACK_PENDING / OWNER_IMPLEMENTATION_PENDING / RUNTIME_V1_DORMANT` — exact five-file evidence chain, immutable commit/image, zero-idle/no-full-scan/query-bound verifier 15/15; source owner now has one-pass implementation/return request | Claude chỉ tiếp tục fixture/parity typed states; không chọn Lane B trước N02+N03 owner acceptance và N04 Rust consumer | `EX_BE_02_N03_TRADING_SYSTEM_INCREMENTAL_SOURCE_IMPLEMENTATION.md`, `TRADING_SYSTEM_D4_PAPER_READ_V2_IMPLEMENTATION_REQUEST.md`, `CODEX_TO_CLAUDE_N03_OWNER_IMPLEMENTATION_HANDOFF.md` |
