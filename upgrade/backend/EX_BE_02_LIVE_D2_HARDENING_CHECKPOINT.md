...
The admitted D2 ceiling is 2.0 vCPU and 1,408 MiB across Edge, Proxy,
PostgreSQL and the short-lived migrator. Long-running reservations total 288
MiB. AWS-HK has 8 vCPU, about 16 GiB RAM, about 9 GiB available and about 66 GiB
free under `/srv`; however full I/O PSI was roughly 8–9 percent during review.
The live window must therefore re-baseline pressure and rollback on a sustained
pressure increase or any Trading System health regression.
