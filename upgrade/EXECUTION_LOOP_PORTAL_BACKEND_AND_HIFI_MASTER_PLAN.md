...
| EX-BE-02 | P0 / foundation complete; D0 evidence and D1 offline preparation complete, D1 owner execution pending | mTLS/delegated-auth boundary, capability negotiation, bounded read-only transport, exact-GET Source Proxy, preflight and rollback; production flags remain false until real SGP↔AWS evidence | safe AWS integration |
