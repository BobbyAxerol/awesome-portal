...
|---|---|---|
| 2026-09-02 | Corrected Phase 3 owner finding BR-EX-75 at the Alpha/Portfolio rich-screen composition seam | one atomic SGP projection response now carries bounded screen facts to all ten Alpha tabs; Portfolio keeps Fleet identity/holdings when optional analytics fails; contracts 115/115, Control API 281/281 plus restore and frontend suite/build pass; dev rebuild/owner review pending, main/stable unchanged |
