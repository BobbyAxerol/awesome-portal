...
export function paperWorkbench(over: Partial<PaperWorkbenchData> = {}): PaperWorkbenchData {
  return {
    ...
    lineage: [
      { label: "artifact", chip: { label: "sha256:9f3c1a…e2", title: "sha256:9f3c1a...e2", href: "/deployments/alphas/av_2088?tab=Audit" } },
      ...
      { label: "deployment", chip: { label: "dep_74", href: "/deployments/paper/dep_74" } },
      { label: "account", chip: { label: "paper-binance-carry-v32", href: "/deployments/accounts/paper-binance-carry-v32" } },
      { label: "venue", chip: { label: "BINANCE · rev 14", href: "/deployments/accounts" } },
    ],
