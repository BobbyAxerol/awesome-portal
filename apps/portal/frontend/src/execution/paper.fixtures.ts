...
export function paperWorkbench(over: Partial<PaperWorkbenchData> = {}): PaperWorkbenchData {
  return {
    ...
    lineage: [
      ...
      { label: "R1", chip: { label: "AP-101", href: "#ap-101" } },
      { label: "R2", chip: { label: "AP-207", href: "#ap-207" } },
      { label: "portfolio", chip: { label: "PF-MAIN", href: "#pf-main" } },
      { label: "deployment", chip: { label: "dep_74" } },
      { label: "account", chip: { label: "paper-binance-carry-v32", href: "#acct" } },
