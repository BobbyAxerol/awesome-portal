...
import { readSubjectActivity, subjectActivityPath } from "./subjectActivity";
...
describe("BR-EX-81 subject activity BFF wire", () => {
  ...
  it("builds only an exact named alpha/account operation", () => {
    expect(subjectActivityPath({ environment: "paper", subjectKind: "alpha", subjectId: "a/b", relation: "orders", limit: 999 })).toBe("/resources/alphas/a%2Fb/orders?environment=paper&limit=500");
