 ...
 * C-PI04-05 gates.
 *
 * The seven codes are read from the edge service source rather than copied into
...
describe("the frontend's code list matches the edge service", () => {
  it("finds the mapping at all", () => {
    ...
    // vacuously.
    expect(edgeCodes().size).toBe(7);
  });

  it("classifies exactly the six 422 codes as correctable", () => {
