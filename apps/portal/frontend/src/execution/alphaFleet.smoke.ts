  ...
  rows: [
    {
      ...
      deployments: [
        ...
        { id: "dep_88", href: "/deployments/live/dep_88", venueMode: "BINANCE · live", chip: { label: "⛨ LIVE_CANARY", tone: "canary", strong: true }, chipNote: "day 9/14 · AP-311", chipNoteLinks: [{ label: "AP-311", href: "/governance/approvals/AP-311/r2" }], alloc: "5,000", pnl: "+112.40", pnlKey: "canary", dd: "−0.8%", account: "acct-canary-grid", accountHref: "/deployments/accounts/acct-canary-grid", portfolio: "PF-CRYPTO", health: "READY · sync", healthTone: "good", syncTick: true },
