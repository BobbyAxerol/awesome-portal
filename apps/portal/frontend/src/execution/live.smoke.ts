...
export interface LiveRow {
  alpha: string; alphaHref: string; dep: string; sub: string; subLinks?: { label: string; href: string }[]; stage: { label: string; canary?: boolean }; venue: string; account: string; accountHref: string; portfolio: string;
...
export const LIVE_SMOKE_DATA = {
  ...
  rows: [
    { alpha: "Grid v2.1", alphaHref: "/deployments/live/dep_live", dep: "dep_live", sub: "live since 2026-08-01 · gate AP-330", subLinks: [{ label: "AP-330", href: "/governance/approvals/AP-330/r2" }], stage: { label: "LIVE_FULL" }, venue: "BINANCE", account: "acct-live-grid-v21", accountHref: "/deployments/accounts/acct-live-grid-v21", portfolio: "PF-CRYPTO", alloc: "18,400", exposure: "12,220", pnlBase: 322.4, pnlK: 0.6, dd: "−1.2%", sparkScale: 0.9, sparkOff: 2, sparkTone: "bad", health: { label: "FAIL-CLOSED", tone: "bad", pulse: true }, hot: true,
    ...
    { alpha: "Carry v3.2", alphaHref: "/deployments/live/dep_live_c32", dep: "dep_live_c32", sub: "live since 2026-08-09 · gate AP-341", subLinks: [{ label: "AP-341", href: "/governance/approvals/AP-341/r2" }], stage: { label: "LIVE_FULL" }, venue: "BINANCE", account: "acct-live-carry-v32", accountHref: "/deployments/accounts/acct-live-carry-v32", portfolio: "PF-CRYPTO", alloc: "14,900", exposure: "8,940", pnlBase: 118.2, pnlK: 0.4, dd: "−0.4%", sparkScale: 0.7, sparkOff: 4, sparkTone: "good", health: { label: "READY", tone: "good" },
      note: "14 orders · 12 fills this session · slippage 4.2bp · risk utilization 52% of profile rev 12", filters: ["full"] },
    { alpha: "Grid v2.1", alphaHref: "/deployments/live/dep_88/canary", dep: "dep_88", sub: "canary gate AP-311 · review day 9/14", subLinks: [{ label: "AP-311", href: "/governance/approvals/AP-311/live" }], stage: { label: "⛨ LIVE · CANARY d9/14", canary: true }, venue: "BINANCE", account: "acct-canary-grid", accountHref: "/deployments/accounts/acct-canary-grid", portfolio: "PF-CRYPTO", alloc: "5,000", exposure: "1,690", pnlBase: 112.4, pnlK: 0.3, dd: "−0.8%", sparkScale: 0.8, sparkOff: 3, sparkTone: "good", health: { label: "READY", tone: "good" },
      note: "canary envelope: max order 500 · scale-up blocked while any sibling account is fail-closed · paper twin dep_94 tracks drift +0.3bp", noteLinks: [{ label: "dep_94", href: "/deployments/paper/dep_94" }], filters: ["canary"] },
    { alpha: "MM v1.1", alphaHref: "/deployments/live/dep_63/canary", dep: "dep_63", sub: "canary gate AP-259 · 1 condition active", subLinks: [{ label: "AP-259", href: "/governance/approvals/AP-259/r2" }], stage: { label: "⛨ LIVE · CANARY d2/14", canary: true }, venue: "BINANCE", account: "acct-canary-mm-v11", accountHref: "/deployments/accounts/acct-canary-mm-v11", portfolio: "PF-CRYPTO", alloc: "7,700", exposure: "4,940", pnlBase: 18.6, pnlK: 0.2, dd: "−0.3%", sparkScale: 0.5, sparkOff: 5, sparkTone: "good", health: { label: "READY", tone: "good" },
