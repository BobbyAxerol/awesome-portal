...
export const LIVE_SMOKE_DATA = {
  ...
  rows: [
    ...
    { alpha: "Grid v2.1", alphaHref: "/deployments/live/dep_88/canary", dep: "dep_88", sub: "canary gate AP-311 · review day 9/14", subLinks: [{ label: "AP-311", href: "/governance/approvals/AP-311/r2" }], stage: { label: "⛨ LIVE · CANARY d9/14", canary: true }, venue: "BINANCE", account: "acct-canary-grid", accountHref: "/deployments/accounts/acct-canary-grid", portfolio: "PF-CRYPTO", alloc: "5,000", exposure: "1,690", pnlBase: 112.4, pnlK: 0.3, dd: "−0.8%", sparkScale: 0.8, sparkOff: 3, sparkTone: "good", health: { label: "READY", tone: "good" },
