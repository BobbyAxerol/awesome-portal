...
export const LIVE_SMOKE_DATA = {
  ...
  rows: [
    ...
    { alpha: "Grid v2.1", alphaHref: "/deployments/live/dep_88", dep: "dep_88", sub: "canary gate AP-311 · review day 9/14", stage: { label: "⛨ LIVE · CANARY d9/14", canary: true }, venue: "BINANCE", account: "acct-canary-grid", accountHref: "/deployments/accounts/acct-canary-grid", portfolio: "PF-CRYPTO", alloc: "5,000", exposure: "1,690", pnlBase: 112.4, pnlK: 0.3, dd: "−0.8%", sparkScale: 0.8, sparkOff: 3, sparkTone: "good", health: { label: "READY", tone: "good" },
    ...
    { alpha: "MM v1.1", alphaHref: "/deployments/live/dep_63", dep: "dep_63", sub: "canary gate AP-259 · 1 condition active", stage: { label: "⛨ LIVE · CANARY d2/14", canary: true }, venue: "BINANCE", account: "acct-canary-mm-v11", accountHref: "/deployments/accounts/acct-canary-mm-v11", portfolio: "PF-CRYPTO", alloc: "7,700", exposure: "4,940", pnlBase: 18.6, pnlK: 0.2, dd: "−0.3%", sparkScale: 0.5, sparkOff: 5, sparkTone: "good", health: { label: "READY", tone: "good" },
      note: "condition: capacity cap 10,000 until 2026-09-02 (expires in 7d, owner Lan) · waivers & conditions", noteLinks: [{ label: "waivers & conditions", href: "/governance/waivers" }], filters: ["canary"] },
  ] as LiveRow[],
  full: {
    title: "Grid v2.1", sub: "PF-CRYPTO · BINANCE", facts: { stage: "LIVE_FULL", tail: "promoted from canary 2026-08-01 · real capital" },
    meta: [{ k: "artifact", v: "sha256:41bb7d…c4", href: "#passport" }, { k: "canary exit", v: "CX-08", href: "/governance/exit-reviews/CX-08" }, { k: "live dual approval", v: "AP-330", href: "/governance/approvals/AP-330" }, { k: "portfolio", v: "PF-CRYPTO", href: "/deployments/portfolios/PF-CRYPTO" }, { k: "deployment", v: "dep_88", href: "/deployments/live/dep_88" }, { k: "account", v: "acct-live-grid-v21", href: "/deployments/accounts/acct-live-grid-v21" }, { k: "venue", v: "BINANCE", href: "/deployments/accounts" }],
    metaNote: "research lineage → drill-down only, never occupies live safety space",
    lifecycle: [{ k: "R1", v: "AP-118", href: "/governance/approvals/AP-118" }, { k: "R2", v: "AP-152", href: "/governance/approvals/AP-152" }, { k: "PAPER", v: "PX-22", href: "/governance/exit-reviews/PX-22" }, { k: "SANDBOX", v: "SX-14", href: "/governance/exit-reviews/SX-14" }, { k: "CANARY", v: "CX-08", href: "/governance/exit-reviews/CX-08" }], lifecycleNow: "LIVE ● since 2026-08-01",
