...
export function vnmWorkbench(over: Partial<PaperWorkbenchProps> = {}): PaperWorkbenchProps {
  return paperWorkbench({
    ...
    lineage: [
      { label: "artifact", chip: { label: "sha256:c44f10…9e", title: "sha256:c44f10...9e" } },
      { label: "R1", chip: { label: "AP-322", href: "#ap-322" } },
      { label: "R2", chip: { label: "AP-338", href: "#ap-338" } },
      { label: "portfolio", chip: { label: "PF-VN", href: "#pf-vn" } },
      { label: "deployment", chip: { label: "dep_102" } },
      { label: "account", chip: { label: "paper-dnse-vnmomo", href: "#acct-vn" } },
      { label: "venue", chip: { label: "VN MARKET · DNSE" } },
    ],
    r1: { label: "AP-322", href: "#ap-322" },
    r2: { label: "AP-338", href: "#ap-338" },
