...
export const CANARY_SMOKE_DATA = {
  ...
  meta: [{ k: "artifact", v: "sha256:41bb7d…c4", href: "/deployments/alphas/av_2041?tab=Audit" }, { k: "R1", v: "AP-118", href: "/governance/approvals/AP-118/r1" }, { k: "R2", v: "AP-152", href: "/governance/approvals/AP-152/r2" }, { k: "sandbox exit", v: "SX-14", href: "/governance/exit-reviews/SX-14" }, { k: "canary dual approval", v: "AP-311", href: "/governance/approvals/AP-311/live" }, { k: "portfolio", v: "PF-CRYPTO", href: "/deployments/portfolios/PF-CRYPTO" }, { k: "deployment", v: "dep_88", href: "/deployments/live/dep_88" }, { k: "account", v: "acct-canary-grid", href: "/deployments/accounts/acct-canary-grid" }, { k: "venue", v: "BINANCE", href: "/deployments/accounts" }],
  metaTail: "rev 3",
  ...
  gates: { done: 4, total: 5, rows: [{ ok: false, t: "min duration — day 9/14 · {exitIn} remaining" }, { ok: true, t: "drift vs paper twin ", link: { label: "dep_94", href: "/deployments/paper/dep_94" }, tail: " — fill Δ +0.3bp · slip Δ +0.8bp · tol 5bp" }, { ok: true, t: "envelope discipline — 0 breaches in 9d" }, { ok: true, t: "reconciliation — clean streak 9d · ", link: { label: "rec_881", href: "/deployments/accounts/acct-canary-grid" } }, { ok: true, t: "incidents — 0 critical in trial window" }], cta: "Request Canary Exit Review — unlocks at 5/5 (d14, or earlier by waiver)" },
