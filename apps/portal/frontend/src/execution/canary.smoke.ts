...
export const CANARY_SMOKE_DATA = {
  ...
  meta: [{ k: "artifact", v: "sha256:41bb7d…c4", href: "#passport" }, { k: "R1", v: "AP-118", href: "/governance/approvals/AP-118" }, { k: "R2", v: "AP-152", href: "/governance/approvals/AP-152" }, { k: "sandbox exit", v: "SX-14", href: "/governance/exit-reviews/SX-14" }, { k: "canary dual approval", v: "AP-311", href: "/governance/approvals/AP-311" }, { k: "portfolio", v: "PF-CRYPTO", href: "/deployments/portfolios/PF-CRYPTO" }, { k: "deployment", v: "dep_88", href: "/deployments/live/dep_88" }, { k: "account", v: "acct-canary-grid", href: "/deployments/accounts/acct-canary-grid" }, { k: "venue", v: "BINANCE", href: "/deployments/accounts" }],
  metaTail: "rev 3",
  lifecycle: [{ k: "R1", v: "AP-118", href: "/governance/approvals/AP-118" }, { k: "R2", v: "AP-152", href: "/governance/approvals/AP-152" }, { k: "PAPER", v: "PX-22", href: "/governance/exit-reviews/PX-22" }, { k: "SANDBOX", v: "SX-14", href: "/governance/exit-reviews/SX-14" }], lifecycleNow: "CANARY ● day 9/14", lifecycleNext: "LIVE —",
  ...
  incidents: [{ k: "critical findings", v: "0 open", tone: "good" }, { k: "last reconciliation", v: "clean · 12m ago · ", link: { label: "rec_881", href: "/deployments/reconciliation?finding=rec_881" }, tone: "good" }, { k: "partial operations", v: "none" }, { k: "scale blockers", v: "none", tone: "good" }],
