...
const RESOURCE_PATTERN = /^(?:(?:alpha|deployment|account):[A-Za-z0-9._-]{1,128}|execution:command-center|execution:screen:(?:gate-r2|blotter|alpha-360|portfolio-360|account-broker-360):[A-Za-z0-9._-]{1,128})$/;
